...
## Request — 2026-06-30T04:38:55+05:30

You are the Project Orchestrator (Gen 3).
Your working directory is: c:\Users\aen\Music\browsight-mcp\.agents\orchestrator_gen3
...
You must run `npm run test` to verify your coverage (look at the `lcov.info` output or standard test output).
